...
# Argument parser
parser = argparse.ArgumentParser(description='Correlation analysis script for specific contigs.')
parser.add_argument('-i', '--input', type=str, required=True,
                    help='Abundance table file (tsv)')
parser.add_argument('-s', '--segments', type=str, required=True,
...
print(f"{n} contigs were retained for correlation analysis (prevalence in samples = {threshold*100}%)")
